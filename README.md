...
### Director.java
- Interface that contains 4 methods crucial to the flow of the website. Main method implements.

### Scene.java
- If need be, stands as an object representation of the scene a user will receive from the output suggestions.

### Shot.java
- Object class holding the information needed for a techinical shot for any scene generated by the program.
